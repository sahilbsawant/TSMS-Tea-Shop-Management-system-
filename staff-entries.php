            ...
            <main>
                ...
                <script>
                    $(document).ready(function() {
                        $.ajax({
                            url: "http://localhost/tea/api-fetch-all-data.php",
                            type: "GET",
                            success: function(data) {
                                ...
                                $.each(obj, function(key, value) {
                                    ...
                                    $("#load-table").append(
                                        ...
                                        "<td> <button class = 'btn btn-primary' data-id = '" + value.ID + "'>Edit</button>  </td>" +
                                        "<td> <button class = 'btn btn-primary' data-id = '" + value.ID + "'>Delete</button>  </td>" +
